...
public class S3UploaderTest {
    ...
    void testS3Upload() throws Exception {
        ...
        try {
            ...
            try (ResponseInputStream<GetObjectResponse> objectContent = s3.getObject(GetObjectRequest.builder()
                    .bucket(bucketName)
                    .key(key)
                    .build());
            ...
            dummyFile.delete();
            s3.close(); // SDK v2 では明示的にクライアントをクローズする
        }
    }
}